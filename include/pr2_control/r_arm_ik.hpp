...
namespace pr2_control
{
	...
	{
	    public:
		Transform_r_ik(const ros::NodeHandle& nh): nh_(nh), base_frame_("base_link"), target_frame_("r_gripper_tool_frame"), once_(true)
		{}
...
// TODO: print input msg
		...
		{			
			...
			catch(std::exception& e)
			{
		 	...
		 	sub_goal_ = nh_.subscribe("/tf_goal", 1, &Transform_r_ik::goalCallback, this);	
