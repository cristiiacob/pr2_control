#ifndef PR2_CONTROL_L_ARM_CONTROLLER_HPP
#define PR2_CONTROL_L_ARM_CONTROLLER_HPP
...
namespace pr2_control
{
	...
	{	
	   public:
		...
		RobotLArm(const ros::NodeHandle& nh): nh_(nh)
		{
			// tell the action client that we want to spin a thread by default
			traj_client_arm_ = new TrajClient("/l_arm_controller/follow_joint_trajectory", true);
			...
			{
				ROS_INFO("Waiting for the /l_arm_controller/follow_joint_trajectory server");
			}
