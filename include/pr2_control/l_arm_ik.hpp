#ifndef PR2_CONTROL_L_ARM_IK_HPP
#define PR2_CONTROL_L_ARM_IK_HPP
...
// TODO: print input msg
		...
		{			
			...
			sub_state_ = nh_.subscribe("joint_states", 1, &Transform_l_ik::stateCallback, this);
			...
			catch(std::exception& e)
			{
		 	...
		 	sub_goal_ = nh_.subscribe("/tf_goal", 1, &Transform_l_ik::goalCallback, this);	
