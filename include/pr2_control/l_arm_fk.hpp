#ifndef PR2_CONTROL_L_ARM_FK_HPP
#define PR2_CONTROL_L_ARM_FK_HPP
...
{
	class Transform_l_fk
	{

	    public:
		Transform_l_fk(const ros::NodeHandle& nh): nh_(nh), base_frame_("base_link"), target_frame_("l_gripper_tool_frame"), once_(true)
		{}
	...
	//	        std::cout << kdl_pose << std::endl;
		...
		{			
			...
			joint_names_ = getJointNames(chain_);	
		 	sub_ = nh_.subscribe("joint_states", 1, &Transform_l_fk::chatterCallback, this);
	    	}	
